 ...
 */
const datums = {
    WGS84: { ellipsoid: LEellipsoids.WGS84 },
};


// freeze static properties
Object.freeze(LEellipsoids.WGS84);
...
class LatLonEllipsoidal {
    ...
    /**
     * LEellipsoids with their parameters; this module only defines WGS84 parameters a = 6378137, b =
     * 6356752.314245, f = 1/298.257223563.
     *
     * @example
     *   const a = LatLon.LEellipsoids.WGS84.a; // 6378137
     */
    static get LEellipsoids() {
        return LEellipsoids;
    }
    ...
    toCartesian() {
        ...
        const ellipsoid = this.datum
            ...
            : this.referenceFrame ? this.referenceFrame.ellipsoid : LEellipsoids.WGS84;
...
class Cartesian extends Vector3d {
     ...
     *
     * @param   {LatLon.LEellipsoids} [ellipsoid=WGS84] - Ellipsoid to use when converting point.
     ...
     */
    toLatLon(ellipsoid=LEellipsoids.WGS84) {
